...
class Ui_Companies(object):
    def setupUi(self, Companies):
        ...
        Companies.resize(793, 620)
        self.centralwidget = QtWidgets.QWidget(Companies)
        self.centralwidget.setObjectName("centralwidget")
        self.stackedWidget = QtWidgets.QStackedWidget(self.centralwidget)
        self.stackedWidget.setGeometry(QtCore.QRect(110, 180, 500, 471))
        ...
        self.lb_lent.setGeometry(QtCore.QRect(220, 160, 81, 20))
        ...
        self.lb_lent_2.setGeometry(QtCore.QRect(210, 120, 91, 20))
        ...
        self.layoutWidget2.setGeometry(QtCore.QRect(100, 180, 278, 33))
        ...
        self.layoutWidget4.setGeometry(QtCore.QRect(110, 160, 268, 33))
        ...
        self.layoutWidget5.setGeometry(QtCore.QRect(120, 10, 507, 33))
        ...
        self.layoutWidget6.setGeometry(QtCore.QRect(190, 70, 331, 71))
    ...
    def retranslateUi(self, Companies):
        ...
        self.lb_borrowed.setText(_translate("Companies", "欠款列表"))
        self.lb_lent.setText(_translate("Companies", "借出列表"))
        self.btn_submit_trans.setText(_translate("Companies", "确认"))
        self.btn_reset_trans.setText(_translate("Companies", "重置"))
        self.lb_amount_trans.setText(_translate("Companies", "金额"))
        self.lb_date_trans.setText(_translate("Companies", "截止日期"))
        self.lb_lent_2.setText(_translate("Companies", "借出列表"))
        self.lb_borrowed_2.setText(_translate("Companies", "欠款列表"))
        self.label_2.setText(_translate("Companies", "购买"))
        self.lb_from_pur.setText(_translate("Companies", "卖家"))
        self.lb_amount_pur.setText(_translate("Companies", "金额"))
        self.lb_date_pur.setText(_translate("Companies", "还款期限"))
        self.btn_submit_pur.setText(_translate("Companies", "确认"))
        self.btn_reset_pur.setText(_translate("Companies", "重置"))
        self.label.setText(_translate("Companies", "向银行融资"))
        self.lb_amount_finance.setText(_translate("Companies", "金额"))
        self.lb_date_fin.setText(_translate("Companies", "期限"))
        self.btn_submit_fin.setText(_translate("Companies", "确认"))
        self.btn_reset_fin.setText(_translate("Companies", "重置"))
        self.btn_ok_repay.setText(_translate("Companies", "确认"))
        self.label_3.setText(_translate("Companies", "请点击以下记录进行选择："))
        self.btn_info.setText(_translate("Companies", "基本信息"))
        self.btn_transfer.setText(_translate("Companies", "转移"))
        self.btn_purchase.setText(_translate("Companies", "购买"))
        self.btn_finance.setText(_translate("Companies", "融资"))
        self.btn_repay.setText(_translate("Companies", "还款"))
        self.btn_quit.setText(_translate("Companies", "退出"))
        self.lb_total_b.setText(_translate("Companies", "总欠款金额"))
        self.lb_total_l.setText(_translate("Companies", "总借出金额"))
